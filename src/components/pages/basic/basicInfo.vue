<template>
  <div class="basicInfo" style="overflow:hidden">
    <el-form :inline="true" :disabled="disabled" :model="basicForm" :rules="rules" ref="basicForm" label-width="140px"
      ...
      <el-form-item label="联系方式1：" prop="relationType1">
        <el-input type="number" v-model="basicForm.relationType1" auto-complete="off"></el-input>
      </el-form-item>
      <el-form-item label="联系方式2：" prop="relationType2">
        <el-input type="number" v-model="basicForm.relationType2" auto-complete="off"></el-input>
      </el-form-item>
      <el-form-item label="联系方式3：" prop="relationType3">
        <el-input type="number" v-model="basicForm.relationType3" auto-complete="off"></el-input>
      </el-form-item>
      <el-form-item label="档案号：" prop="archivesNo">
        <el-input type="text" v-model="basicForm.archivesNo" auto-complete="off"></el-input>
      </el-form-item>
