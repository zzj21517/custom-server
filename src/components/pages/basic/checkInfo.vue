<template>
    <div>
         <el-form :disabled='disabled' :inline="true" :model="checkInfo" :rules="rules" ref="checkInfo" label-width="180px" size="small" label-position="right" >
              <el-form-item label="鉴定日期：" prop="checkTime">
              <el-date-picker value-format="yyyy-MM-dd" v-model="checkInfo.checkTime" type="date" placeholder="选择日期" ></el-date-picker>
            </el-form-item>
            <el-form-item label="委托机构：" prop="deleOrgan">
              <el-input type="text" v-model="checkInfo.deleOrgan" auto-complete="off" ></el-input>
            </el-form-item>
            <el-form-item label="陪同鉴定人：" prop="accomPerson">
              <el-input type="text" v-model="checkInfo.accomPerson" auto-complete="off" ></el-input>
            </el-form-item>
            <el-form-item label="鉴定法医：" prop="forensic">
              <el-input type="text" v-model="checkInfo.forensic" auto-complete="off" ></el-input>
            </el-form-item>
            <el-form-item label="精神鉴定预约时间：" prop="spiritPoint">
              <el-date-picker value-format="yyyy-MM-dd" v-model="checkInfo.spiritPoint" type="date" placeholder="选择日期" ></el-date-picker>
            </el-form-item>
            <el-form-item label="报告领取时间：" prop="reportTime">
              <el-date-picker value-format="yyyy-MM-dd" v-model="checkInfo.reportTime" type="date" placeholder="选择日期" ></el-date-picker>
            </el-form-item>
